...
ASCII_FILE = PROJECT_ROOT / "assets" / "ascii-art.txt"
...
def print_help_text() -> None:
    print()
    print("\033[1mComandi disponibili:\033[0m")
    print()
    print("  \033[92;1m— Docs\033[0m")
...
def build_parser() -> argparse.ArgumentParser:
    ...
    pivot_p = subparsers.add_parser("pivot", add_help=False)
    pivot_p.add_argument("action", nargs="?", default="status")
    pivot_p.add_argument("route_action", nargs="?", default=None)
    pivot_p.add_argument("cidr", nargs="?", default=None)
    pivot_p.add_argument("--port", type=int, default=11601)
    pivot_p.add_argument("--force", action="store_true", default=False)
